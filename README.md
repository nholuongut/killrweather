...
[Apache Cassandra](http://cassandra.apache.org), and [Apache Kafka](http://kafka.apache.org) for fast, streaming computations in asynchronous [Akka](http://akka.io) event-driven environments. This application focuses on the use case of  **[time series data](https://github.com/nholuongut/killrweather/wiki/4.-Time-Series-Data-Model)**.  
  
## Basic Samples
[Basic Spark, Kafka, Cassandra Samples](https://github.com/nholuongut/killrweather/tree/master/killrweather-examples/src/main/scala/com/datastax/killrweather)

## Reference Application 
[KillrWeather Main App](https://github.com/nholuongut/killrweather/tree/master/killrweather-app/src/main/scala/com/datastax/killrweather)
...
## Start Here
* [KillrWeather Wiki](https://github.com/nholuongut/killrweather/wiki) 
* com.datastax.killrweather [Spark, Kafka and Cassandra workers](http://github.com/nholuongut/killrweather/tree/master/killrweather-app/src/it/scala/com/datastax/killrweather)

### Clone the repo

    git clone https://github.com/nholuongut/killrweather.git
    cd killrweather
...
- [logback.xml](http://github.com/nholuongut/killrweather/tree/master/killrweather-core/src/resources/logback.xml)
...
#### From an IDE
1. Run the app [com.datastax.killrweather.KillrWeatherApp](https://github.com/nholuongut/killrweather/blob/master/killrweather-app/src/main/scala/com/datastax/nholuongut/killrweatherApp.scala)
2. Run the kafka data ingestion server [com.datastax.killrweather.KafkaDataIngestionApp](https://github.com/nholuongut/killrweather/blob/master/killrweather-clients/src/main/scala/com/datastax/killrweather/KafkaDataIngestionApp.scala)
3. Run the API client [com.datastax.killrweather.KillrWeatherClientApp](https://github.com/nholuongut/killrweather/blob/master/killrweather-clients/src/main/scala/com/datastax/nholuongut/killrweatherClientApp.scala)
